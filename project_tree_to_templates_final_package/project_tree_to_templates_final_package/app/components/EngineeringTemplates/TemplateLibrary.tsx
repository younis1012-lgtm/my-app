  ...
  return (
    <main dir="rtl" style={{ minHeight: "100vh", background: "linear-gradient(180deg,#f8fafc,#eef4f8)", padding: 24 }}>
      ...
      >
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "space-between", gap: 18, alignItems: "center", flexWrap: "wrap" }}>
          <div>
            <div style={{ color: "#f59e0b", fontWeight: 950, letterSpacing: 1 }}>RND QUALITY CONTROL</div>
            <h1 style={{ margin: "10px 0 6px", fontSize: 32 }}>ספריית תבניות / עץ פרויקט חדש</h1>
