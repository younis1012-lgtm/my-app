...
export type ChecklistAttachmentKind = 'lab' | 'measurement' | 'document' | 'other';
export type ChecklistAttachment = { id?: string; name: string; type?: string; dataUrl?: string; kind: ChecklistAttachmentKind; uploadedAt: string; labResults?: any; results?: any; };
export type ChecklistItem = { id: string; description: string; responsible: string; status: string; notes: string; inspector: string; executionDate: string; attachments?: ChecklistAttachment[]; labResults?: any; results?: any; };
