...
export default function Page() {
  ...
  const exportLogoSrc = () =>
    typeof window !== 'undefined'
      ? `${window.location.origin}/controleng-prime-logo.png`
      : CONTROLENG_LOGO_DATA_URI;
  const exportLogoHtml = () => `<div class="export-logo-wrap"><img class="doc-logo" src="${exportLogoSrc()}" alt="CONTROLENG PRIME LTD" /></div>`;
