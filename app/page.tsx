    ...
    <div style={styles.page} dir="rtl">
      ...
      <div style={styles.layout}>
        <main style={styles.mainCard}>
          ...
          {section === 'home' && <HomeSection projects={accessibleProjects} projectChecklists={projectChecklists} projectNonconformances={projectNonconformances} projectTrialSections={projectTrialSections} projectPreliminary={projectPreliminary} projectRFIs={projectRfis} projectSupervisionReports={[]} homeModules={homeModules} setSection={setSection as any} />}
