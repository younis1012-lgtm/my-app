...
export default function Page() {
  ...
  const exportCompanyHeader = () => `<div class="company-header" dir="rtl">
    ...
    <table class="company-header-box" role="presentation" cellspacing="0" cellpadding="0">
      <tbody>
        <tr>
          <td class="company-header-single-cell">
            <div class="company-header-content">
              <img class="company-full-logo" src="${exportLogoSrc()}" alt="CONTROLENG PRIME LTD" />
            </div>
          </td>
        </tr>
      </tbody>
  ...
  const exportCompanyFooter = () => `<div class="company-footer" dir="rtl">
    <div class="company-line"></div>
    <div class="company-footer-single-line">
      <span class="company-footer-contact"><span>בית ג׳אן 249900</span><span class="company-footer-separator">|</span><span dir="ltr">q.controling@gmail.com</span></span>
  ...
  const exportStyles = `
    ...
    .company-header{width:100%;margin:0 0 8px;page-break-inside:avoid;box-sizing:border-box;clear:both}
    .company-line{height:3px;background:#8a7d5b;width:100%;margin:0;padding:0;font-size:0;line-height:0}
    .company-header-box{width:100%;border-collapse:collapse;table-layout:fixed;margin:6px 0;border:0!important}
    .company-header-box td{border:0!important;background:#fff!important;padding:0!important;vertical-align:middle!important}
    .company-header-single-cell{height:52px!important;text-align:right!important;direction:rtl!important}
    .company-header-content{width:100%;height:52px;display:block;text-align:right!important;direction:rtl!important;overflow:hidden}
    .company-full-logo{height:50px!important;max-height:50px!important;width:auto!important;max-width:92px!important;display:inline-block!important;border:0!important;object-fit:contain!important;vertical-align:middle!important;margin:0!important;padding:0!important}

    .company-footer{width:100%;margin:8px 0 0;page-break-inside:avoid;box-sizing:border-box;clear:both}
    .company-footer-single-line{width:100%;box-sizing:border-box;padding:4px 2px 0;font-size:8.5px!important;font-weight:700!important;line-height:1.1!important;direction:rtl!important;white-space:nowrap;overflow:hidden;border:0!important;background:#fff!important;min-height:16px}
    .company-footer-contact{float:right;text-align:right;direction:rtl!important;display:inline-block;max-width:58%}
    .company-footer-service{float:left;text-align:left;direction:rtl!important;display:inline-block;max-width:40%}
    ...
    @media print{
      ...
      .company-header{margin-bottom:6px}.company-header-box{margin:5px 0}.company-header-single-cell{height:46px!important}.company-header-content{height:46px!important}.company-full-logo{height:44px!important;max-height:44px!important;max-width:82px!important}
      .company-footer{margin-top:6px}.company-footer-single-line{font-size:8px!important;min-height:14px!important}.trial-report{width:100%}
    }
  `;
