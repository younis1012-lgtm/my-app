...
export default function Page() {
  ...
  const exportCompanyHeader = () => `<div class="company-header">
    <div class="company-logo-panel"><img class="company-header-logo" src="${exportLogoSrc()}" alt="CONTROLENG PRIME LTD" /></div>
    <div class="company-header-content">
      <div class="company-header-email">q.controling@gmail.com</div>
      <div class="company-header-address">בית ג'אן 249900</div>
      <div class="company-header-subtitle">שירותי הנדסה, פיקוח ובקרת איכות</div>
    </div>
  </div>`;
  ...
  const exportStyles = `
    ...
    .company-header{width:100%;height:78px;margin:0 0 6px;display:table;border:0;background:#f7f7f5;overflow:hidden;page-break-inside:avoid}
    .company-logo-panel{display:table-cell;width:30%;vertical-align:middle;text-align:center;background:#81765a;padding:4px 10px;border:0}
    .company-header-logo{width:95px;height:auto;display:inline-block;vertical-align:middle}
    .company-header-content{display:table-cell;width:70%;vertical-align:middle;text-align:left;padding:7px 18px 7px 28px;border:0;background:#f7f7f5;color:#2f3338;font-weight:700}
    .company-header-email{font-size:18px;line-height:1.3;margin-bottom:6px}
    .company-header-address{font-size:15px;line-height:1.25;margin-bottom:4px}
    .company-header-subtitle{font-size:10px;line-height:1.1;color:#81765a;text-align:left}
    ...
    @media print{button{display:none} body{padding:0;font-size:8px}.header-title{font-size:13px} th,td{padding:1px 2px}.doc-header td{height:15px}.source-meta td{height:14px}.check-table td{height:14px}.check-table th{height:14px}.company-header{height:72px;margin-bottom:5px}.company-header-logo{width:88px}.company-header-email{font-size:17px}.trial-report{width:82%}}
  `;
