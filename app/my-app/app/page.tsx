      ...
      if (!isSupabaseConfigured) {
        ...
        try {
          ...
          if (parsed.savedChecklists) {
            setSavedChecklists(parsed.savedChecklists.map((item) => ({ ...item, templateKey: normalizeChecklistTemplateKey(item.templateKey), items: normalizeChecklistItems(item.items) })));
          }
