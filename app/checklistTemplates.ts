...
export const checklistTemplates = {
  ...
  sewerLines: {
    label: 'קווי ביוב',
    title: 'רשימת תיוג לקווי ביוב',
    category: 'קווי ביוב',
    procedureNo: '57.03',
    formNo: '57.03.2',
    items: [
      ['אישור לקבלן משנה', 'בקרת איכות'],
      ['אישור לספקי החומרים', 'בקרת איכות'],
      ['אישור לחומרים', 'בקרת איכות'],
      ['אישור Shop Drawing (אם נדרש לפי החוזה)', 'בקרת איכות'],
      ['עבודה עם תוכניות מעודכנות — יש לציין מספר תוכנית', 'בקרת איכות'],
      ['סימון תוואי קו וחפירה', 'מודד'],
      ['בדיקה ויזואלית של חומרים וציוד', 'מנהל עבודה'],
      ['ביצוע חפירת תעלה לעומק הנדרש', 'מנהל עבודה'],
      ['מדידת AS MADE', 'מודד'],
      ['תושבת מחול או מחומר אחר מאושר', 'מנהל עבודה'],
      ['הנחת שוחות / תאי ביוב', 'מנהל עבודה'],
      ['הנחת צנרת ביוב', 'מנהל עבודה'],
      ['בדיקה ויזואלית של החומרים והציוד לאחר ההנחה', 'מנהל עבודה'],
      ['כיסוי צנרת בחומר מאושר', 'מנהל עבודה'],
      ['בדיקת אטימות לצנרת ולתאי ביקורת / שוחות — יש לצרף אישור', 'בקרת איכות'],
      ['צילום קווי ביוב — יש לצרף דוח בדיקה', 'בקרת איכות'],
      ['אישור סופי לקטע', 'בקרת איכות'],
    ].map(([description, responsible], index) => ({
      id: `sewerLines-${index + 1}`,
      description,
      responsible,
      status: 'לא נבדק',
      notes: '',
